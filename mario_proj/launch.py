...
cactus_img = pygame.image.load('mario_proj/sprites/cactus_bricks.png')
cactus_img_rect = cactus_img.get_rect()
cactus_img_rect.left = 0
fire_img = pygame.image.load('mario_proj/sprites/fire_bricks.png')
...
class Dragon:
    ...
    def __init__(self):
        self.dragon_img = pygame.image.load('mario_proj/sprites/dragon.png')
...
class Flames:
    ...
    def __init__(self):
        self.flames = pygame.image.load('mario_proj/sprites/fireball.png')
...
class Mario:
    ...
    def __init__(self):
        self.mario_img = pygame.image.load('mario_proj/sprites/maryo.png')
...
def game_over():
    ...
    music = pygame.mixer.Sound('mario_proj/sounds/mario_dies.wav')
    music.play()
    topscore.top_score(SCORE)
    game_over_img = pygame.image.load('mario_proj/sprites/end.png')
...
def start_game():
    canvas.fill(BLACK)
    start_img = pygame.image.load('mario_proj/sprites/start.png')
...
def game_loop():
    while True:
        ...
        global  HIGH_SCORE
        flames_list = []
        pygame.mixer.music.load('mario_proj/sounds/mario_theme.wav')
